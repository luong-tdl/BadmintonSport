...
namespace GraniteHouse.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        {
            var products = _db.Products.Include(m => m.ProductTypes).Include(m => m.SpecialTags).Include(m=>m.Provider);
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ProductsVM.Products = await _db.Products.Include(m => m.SpecialTags).Include(m => m.ProductTypes).Include(m=>m.Provider).SingleOrDefaultAsync(m => m.Id == id);
        ...
        public async Task<IActionResult> Edit(int id)
        {
            if(ModelState.IsValid)
            {
                ...
                productFromDb.ProviderId = ProductsVM.Products.ProviderId;
